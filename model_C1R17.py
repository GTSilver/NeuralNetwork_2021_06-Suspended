...
model.add(libI.Conv2D(32, (5, 5), input_shape=(5, 222, 1), padding="same"))
model.add(libI.Dropout(0.15))
model.add(libI.MaxPool2D(pool_size=(1, 2)))
# 256 5-2 5-2
...
err1 = (str(round(errors1[0] * itemAccurasity, 1)) + " " +
        str(round(errors1[1] * itemAccurasity, 1)) + " " +
        str(round(errors1[2] * itemAccurasity, 1)) + " " +
        # str(round(errors1[3] * m, 1)) + " " +
        str(round(sklearn.metrics.mean_absolute_error(trainY, prediction1) * itemAccurasity, 1)))
print(err1)
...
err2 = (str(round(errors2[0] * itemAccurasity, 1)) + " " +
        str(round(errors2[1] * itemAccurasity, 1)) + " " +
        str(round(errors2[2] * itemAccurasity, 1)) + " " +
        # str(round(errors2[3] * m, 1)) + " " +
        str(round(sklearn.metrics.mean_absolute_error(testY, prediction2) * itemAccurasity, 1)))
print(err2)
...
err3 = (str(round(errors3[0] * itemAccurasity, 5)) + " " +
        str(round(errors3[1] * itemAccurasity, 5)) + " " +
        str(round(errors3[2] * itemAccurasity, 5)) + " " +
        # str(round(errors3[3] * m, 5)) + "\t" +
        str(round(sklearn.metrics.mean_squared_error(trainY, prediction3) * itemAccurasity, 4)))
print(err3)
...
err4 = (str(round(errors4[0] * itemAccurasity, 5)) + " " +
        str(round(errors4[1] * itemAccurasity, 5)) + " " +
        str(round(errors4[2] * itemAccurasity, 5)) + " " +
        # str(round(errors4[3] * m, 5)) + " " +
        str(round(sklearn.metrics.mean_squared_error(testY, prediction4) * itemAccurasity, 4)))
print(err4)
...
plt.ylim(0, 0.1)
plt.legend()
idNumber = str(round(sklearn.metrics.mean_absolute_error(testY, prediction2) * itemAccurasity, 2))
...
pathNew = directory.split('-')[0] + " " + err3 + "-R17"
